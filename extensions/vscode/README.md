...
```bash
code --install-extension extensions/vscode/codex-radar-vscode-0.2.8.vsix --force
```
...
12. Hide a session, then restore it from `Hidden` or the dashboard hidden list.
