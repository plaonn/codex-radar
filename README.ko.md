...
<p align="center"><strong>공개 베타 · v0.4.19</strong></p>
...
공개 베타는 POSIX 지원 helper bundle과 VSIX를 포함한 [v0.4.19 GitHub Release](https://github.com/plaonn/codex-radar/releases/tag/v0.4.19)로 배포됩니다. VS Code Marketplace나 PyPI에는 게시되어 있지 않습니다.
...
v0.4.19 release는 Python 3.9 이상 POSIX 지원 경로에 helper runtime `0.4.10`을 제공합니다. Installer는 checksum을 검증하고 변경 불가능한 runtime version을 보존하며, Codex hook 설정을 바꾸지 않고 원자적 upgrade와 rollback을 제공합니다. v0.4.19 Release에서 bundle과 인접 checksum을 다운로드한 다음 실행합니다.
...
[v0.4.19 공개 베타 Release](https://github.com/plaonn/codex-radar/releases/tag/v0.4.19)에서 [`codex-radar-vscode-0.4.19.vsix`](https://github.com/plaonn/codex-radar/releases/download/v0.4.19/codex-radar-vscode-0.4.19.vsix)를 다운로드한 다음, Codex와 Radar 상태가 있는 VS Code 확장 호스트에 설치합니다.
...
현재 릴리스는 [Codex Radar 0.4.19 공개 베타](https://github.com/plaonn/codex-radar/releases/tag/v0.4.19)입니다. 공개 베타의 지원되는 배포 경로는 GitHub Release asset입니다. Marketplace 및 PyPI 게시는 별도의 향후 결정으로 남아 있습니다.

자세한 내용은 [0.4.19 릴리스 노트](docs/releases/0.4.19.md)와 [확장 변경 이력](extensions/vscode/CHANGELOG.md)을 참고합니다.
