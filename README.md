...
<p align="center"><strong>Public Beta · v0.4.19</strong></p>
...
The public beta is distributed through the [v0.4.19 GitHub Release](https://github.com/plaonn/codex-radar/releases/tag/v0.4.19), with a POSIX-supported helper bundle and VSIX. It is not published to the VS Code Marketplace or PyPI.
...
Download [`codex-radar-vscode-0.4.19.vsix`](https://github.com/plaonn/codex-radar/releases/download/v0.4.19/codex-radar-vscode-0.4.19.vsix) from the [v0.4.19 Public Beta release](https://github.com/plaonn/codex-radar/releases/tag/v0.4.19), then install it into the VS Code extension host where Codex and Radar state live:
...
The current release is [Codex Radar 0.4.19 Public Beta](https://github.com/plaonn/codex-radar/releases/tag/v0.4.19). GitHub Release assets are the supported public beta distribution path. Marketplace and PyPI publication remain separate future decisions.

See the [0.4.19 release notes](docs/releases/0.4.19.md) and [extension changelog](extensions/vscode/CHANGELOG.md) for details.
